...
export default function Login() {
    ...
    return (
        <>
            <div className={!loading ? "loginpage container-fluid m-0 text-center" : "d-none"} style={{
            ...
            <div className={loading ? "loader d-flex justify-content-center align-items-center" : "d-none"}>
                <h4>Loading.....</h4>
            </div >
        </>
    )
